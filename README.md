...
```
java -Dspring.profiles.active=production -jar ./build/libs/CalendarAppo-0.0.1-SNAPSHOT.jar
```
...
```
gradlew bootBuildImage --imageName=com.kmuniz.calendarappo/calendar-appo
```
